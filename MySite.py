...
app.secret_key = 'your_secret_key'  # Устанавливаем секретный ключ для работы с сессиями, он необходим для защиты сессий пользователей

# Настройки подключения к базе данных PostgreSQL
db_conn = psycopg2.connect(
    dbname="dataofuser",  # Имя базы данных, с которой мы собираемся работать
    user="postgres",  # Имя пользователя для подключения к базе данных
    password="1357", # Пароль для доступа к базе данных, используйте безопасный пароль в реальных проектах
